# GUI for the Instrument,
# By Pavel Milanes pavelmc@gmail.com
#
# Based on the Scalar netork analyser by R Heslip
# that is based on SpectrumAnalyzer-v01a.py
# For Python version 2.6 or 2.7
#
# Changelog July 2017 - first try.
...
STARTfrequency =   100000.0        # Startfrequency
STOPfrequency = 220000000.0     # Stopfrequency
...
def BAutoY():  # auto adjust offset and range
    ...
    DBlevel=int (maxDB)
    # make the range a little bit bigger
...
def Sweep():   # Read samples
    ...
    while (True):                                           # Main loop
        ...
        if (RUNstatus == 1):
            ...
            TRACESopened = 1
            try:
                ser = serial.Serial(SERIALPORT, SERIALPORT_SPEED, timeout=SERIALPORT_TIMEOUT)
                RUNstatus = 2
